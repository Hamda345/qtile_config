...
- group_names list represents number keys for AZERTY keyboard layouts, you can repplace them with numbers from 1 to 8 if you have different keyboard layout like QWERTY
- Group names (workspaces) will be labaled with icons instead of numbers using group_labels list
#+begin_src python
...
* Bar and Widgets:
Setting up Top bar and widgets inside inside the BAR
#+begin_src python
